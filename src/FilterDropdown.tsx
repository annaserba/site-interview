...
export function FilterDropdown({ label, value, options, onChange }: FilterDropdownProps) {
  ...
  return (
    <div className={open ? 'filter-dropdown open' : 'filter-dropdown'} ref={rootRef}>
      <button type="button" className="filter-trigger" onClick={() => setOpen((current) => !current)} aria-expanded={open}>
