...
Согласованность гарантирует, что чтение возвращает самую свежую запись. Linearizable — strongest: операции выглядят как в однопоточной системе. Eventual — данные в конечном счёте синхронизируются, ноно могут быть устаревшими. В CAP при Partition Tolerance выбираем: CP (ZooKeeper — согласованность, но недоступен при split) или AP (Cassandra — доступна, но может вернуть устаревшие данные).
