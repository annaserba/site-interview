...
Inverted index — структура данных для быстрого поиска по содержимому. Мапит terms → documents. Каждый term указывает на список документов, где он встречается. Основаового поиска (Elasticsearch, Lucene).
