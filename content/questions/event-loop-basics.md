...
- Думать, что setTimeout(fn, 0) выполняется немедленно
- Не знать разницу между micro и macrotask
- Путать однопоточность с отсутствием асинхронности
- Блокировать Call Stack тяжёлыми вычислениями
