...
- Перечислять только названия систем, не указывая протокол передачи и гарантии доставки (at-least-once, exactly-once).
- Не различать сырой слой и витрину — смешивать source-of-truth и production data.
- Не учитывать задержку replication lag при ответе на вопрос о свежести данных в витрине.
- Игнорировать schema evolution: не упоминать, как обрабатывали добавление или удаление полей в источнике.
