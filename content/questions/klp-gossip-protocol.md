...
Каждый узел周期性会选择 random peer, обменивается state. Сloopy convergence: информация reaches all nodes.

### Типы

Push: send自己的 state. Pull: request peer's state. Push-pull: оба варианта.
