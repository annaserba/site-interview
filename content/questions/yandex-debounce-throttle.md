...
Важно: оба метода сохраняют контекст вызова через .apply(this, args) и поддерживают отмену через .cancel(). В реальных проектах lodashrottle/lodash.debounce покрывают edge cases, но понимание реализации с нуля — это must have.
